...
if submitted:
  ...
  with res_col:
    ...
    <div style="background:{info['bg']};border:1.6px solid {info['border']};
        ...
        <div styl ="font-size:44px">{info['icon']}</div>
  ...
  with prob_Col:
    ...
    for idx, dname in sorted_depts:
      ...
      <div style="margin-bottom:14px;'>
        <div style="display:flex;justify-contente:space-between;align-items:center;margin-bottom:5px;">
            ...
            <div style="background:#f3f4f6:border-radius:6px;height:8px;overflow:hidden;">
                <div style="background:{'linear-gradient(90deg, '+dinfo['color']+','+dinfo['border']+')' if is_top else '#e5e7eb'}
                            height:100%;border-radius:6px;width:{pct}%;transition:width 0.5 ease;"></div>
            </div>
      </div>"""
